  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h1 className="text-[28px] font-semibold tracking-tight text-foreground leading-tight">Control de cambios</h1>
          <p className="text-[15px] text-muted-foreground mt-1">Gestiona cambios para proyectos finalizados</p>
        </div>
        ...
        {stats.map((stat) => (
          <GlassPanel key={stat.title} padding={2.25}>
            ...
            {loading ? (
              ...
              <p className="text-[28px] font-semibold tracking-tight leading-none mt-2" style={{ color: stat.accent }}>
                {stat.value}
              </p>
            )}
          </GlassPanel>
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[12px] text-muted-foreground truncate mt-0.5">
                      {[project.parent_project?.name, project.company?.name, project.pm?.full_name].filter(Boolean).join(' · ') || 'Sin proyecto origen'}
                    </p>
                  </div>
