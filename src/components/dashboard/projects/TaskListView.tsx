...
const categoryIcons: Record<string, string> = {
  task: '📋', bug: '🐛', feature: '✨', hotfix: '🔥', fix: '🔧',
  improvement: '📈', refactor: '♻️', docs: '📝', test: '🧪', chore: '🔨',
}
const categoryLabels: Record<string, string> = {
  task: 'Tarea', bug: 'Bug', feature: 'Feature', hotfix: 'Hotfix', fix: 'Fix',
  improvement: 'Mejora', refactor: 'Refactor', docs: 'Docs', test: 'Test', chore: 'Chore',
}
