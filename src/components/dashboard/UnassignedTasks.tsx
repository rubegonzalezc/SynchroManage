            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 flex-wrap shrink-0">
                  ...
                  {task.category && (
                    <span className={`text-[11px] font-semibold rounded-full px-2.5 py-0.5 ${categoryColors[task.category] || 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300'}`}>
